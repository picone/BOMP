...
if (CWebUser::$data['type'] == USER_TYPE_SUPER_ADMIN) {
	...
	$dashboardGrid[0][$row] = $zabbixStatus;
...
$dashboardGrid[0][$row] = $systemStatus;
...
$dashboardGrid[0][$row] = $hostStatus;
...
$dashboardGrid[0][$row] = $lastIssues;
...
$dashboardGrid[0][$row] = $webMonitoring;
...
if ($dbDiscoveryRules['cnt'] > 0 && check_right_on_discovery()) {
	...
	$dashboardGrid[0][$row] = $discoveryStatus;
