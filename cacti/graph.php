...
if (!(db_fetch_cell("select local_graph_id from graph_templates_graph where local_graph_id=" . $_GET["local_graph_id"]))) {
	print "<strong><font size='+1' color='FF0000'>图形不存在</font></strong>"; exit;
}
...
case 'view':
	...
	<tr bgcolor='#<?php print $colors["header"];?>'>
		<td colspan='3' class='textHeaderDark'>
			<strong>查看图形</strong> '<?php print htmlspecialchars($graph_title);?>'
		</td>
	</tr>
	<?php
					...
					<table width='1' cellpadding='0'>
						<tr>
							...
							<td valign='top' style='padding: 3px;' class='noprint'>
								<a href='<?php print htmlspecialchars("graph.php?action=zoom&local_graph_id=" . $_GET["local_graph_id"]. "&rra_id=" . $rra["id"] . "&view_type=" . $_REQUEST["view_type"]);?>'><img src='images/graph_zoom.gif' border='0' alt='Zoom Graph' title='缩放图形' style='padding: 3px;'></a><br>
								<a href='<?php print htmlspecialchars("graph_xport.php?local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $rra["id"] . "&view_type=" . $_REQUEST["view_type"]);?>'><img src='images/graph_query.png' border='0' alt='CSV Export' title='导出逗号分隔符文件' style='padding: 3px;'></a><br>
								<a href='<?php print htmlspecialchars("graph.php?action=properties&local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $rra["id"] . "&view_type=" . $_REQUEST["view_type"]);?>'><img src='images/graph_properties.gif' border='0' alt='Graph Source/Properties' title='图形源/属性' style='padding: 3px;'></a>
...
case 'zoom':
	...
	<tr bgcolor='#<?php print $colors["header"];?>'>
		<td colspan='3' class='textHeaderDark'>
			<strong>缩放图形</strong> '<?php print htmlspecialchars($graph_title);?>'
		</td>
	</tr>
		...
		<td align='center'>
			<table width='1' cellpadding='0'>
				<tr>
					...
					<td valign='top' style='padding: 3px;' class='noprint'>
						<a href='<?php print htmlspecialchars("graph.php?action=properties&local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $_GET["rra_id"] . "&view_type=" . $_REQUEST["view_type"] . "&graph_start=" . $graph_start . "&graph_end=" . $graph_end);?>'><img src='images/graph_properties.gif' border='0' alt='Graph Source/Properties' title='图形源/属性' style='padding: 3px;'></a>
						<a href='<?php print htmlspecialchars("graph_xport.php?local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $_GET["rra_id"] . "&view_type=" . $_REQUEST["view_type"]);?>&graph_start=<?php print $graph_start;?>&graph_end=<?php print $graph_end;?>'><img src='images/graph_query.png' border='0' alt='CSV Export' title='导出逗号分隔符文件' style='padding: 3px;'></a><br>
...
case 'properties':
	...
	<tr bgcolor='#<?php print $colors["header"];?>'>
		<td colspan='3' class='textHeaderDark'>
			<strong>查看图形属性</strong> '<?php print htmlspecialchars($graph_title);?>'
		</td>
	</tr>
	<tr>
		<td align='center'>
			<table width='1' cellpadding='0'>
				<tr>
					...
					<td valign='top' style='padding: 3px;'>
						<a href='<?php print htmlspecialchars("graph.php?action=zoom&local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $_GET["rra_id"] . "&view_type=" . $_REQUEST["view_type"]);?>'><img src='images/graph_zoom.gif' border='0' alt='Zoom Graph' title='缩放图形' style='padding: 3px;'></a><br>
						<a href='<?php print htmlspecialchars("graph_xport.php?local_graph_id=" . $_GET["local_graph_id"] . "&rra_id=" . $_GET["rra_id"] . "&view_type=" . $_REQUEST["view_type"]);?>'><img src='images/graph_query.png' border='0' alt='CSV Export' title='导出逗号分隔符文件' style='padding: 3px;'></a><br>
