...
if (is_array($xport_array["meta"])) {
	print '"标题:","'          . $xport_array["meta"]["title_cache"]                . '"' . "\n";
	print '"垂直标签:","' . $xport_array["meta"]["vertical_label"]             . '"' . "\n";
	print '"开始时间:","'     . date("Y-m-d H:i:s", $xport_array["meta"]["start"]) . '"' . "\n";
	print '"结束时间:","'       . date("Y-m-d H:i:s", $xport_array["meta"]["end"])   . '"' . "\n";
	print '"步进:","'           . $xport_array["meta"]["step"]                       . '"' . "\n";
	print '"总行数:","'     . $xport_array["meta"]["rows"]                       . '"' . "\n";
	print '"图形编号:","'       . $xport_array["meta"]["local_graph_id"]             . '"' . "\n";
	print '"主机编号:","'        . $xport_array["meta"]["host_id"]                    . '"' . "\n";
