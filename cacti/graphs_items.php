...
function item_edit() {
	...
	html_start_box("<strong>数据源</strong> [host: " . (empty($host["hostname"]) ? "无主机" : $host["hostname"]) . "]", "100%", $colors["header"], "3", "center", "");
				...
				<tr width="100%">
					...
					<td>
						<select name="cbo_host_id" onChange="window.location=document.form_graph_items.cbo_host_id.options[document.form_graph_items.cbo_host_id.selectedIndex].value">
							<option value="graphs_items.php?action=item_edit<?php print $id; ?>&local_graph_id=<?php print get_request_var_request("local_graph_id");?>&host_id=-1&data_template_id=<?php print get_request_var_request("data_template_id");?>"<?php if (get_request_var_request("host_id") == "-1") {?> selected<?php }?>>任意</option>
							<option value="graphs_items.php?action=item_edit<?php print $id; ?>&local_graph_id=<?php print get_request_var_request("local_graph_id");?>&host_id=0&data_template_id=<?php print get_request_var_request("data_template_id");?>"<?php if (get_request_var_request("host_id") == "0") {?> selected<?php }?>>无</option>
							<?php
				...
				<tr>
					...
					<td>
						<select name="cbo_data_template_id" onChange="window.location=document.form_graph_items.cbo_data_template_id.options[document.form_graph_items.cbo_data_template_id.selectedIndex].value">
							<option value="graphs_items.php?action=item_edit<?php print $id; ?>&local_graph_id=<?php print get_request_var_request("local_graph_id");?>&data_template_id=-1&host_id=<?php print get_request_var_request("host_id");?>"<?php if (get_request_var_request("data_template_id") == "-1") {?> selected<?php }?>>任意</option>
							<option value="graphs_items.php?action=item_edit<?php print $id; ?>&local_graph_id=<?php print get_request_var_request("local_graph_id");?>&data_template_id=0&host_id=<?php print get_request_var_request("host_id");?>"<?php if (get_request_var_request("data_template_id") == "0") {?> selected<?php }?>>无</option>
							<?php
	...
	$header_label = "[编辑图形: " . db_fetch_cell("select title_cache from graph_templates_graph where local_graph_id=" . get_request_var_request("local_graph_id")) . "]";
