...
if (read_config_option("auth_method") != 0) {
	...
	if (empty($_SESSION["sess_user_id"])) {
		if(substr($_SERVER['HTTP_REFERER'],-9)=='left.html')
		...
		if ($realm_id != -1 && ((!db_fetch_assoc("select
			...
			if (isset($_SERVER["HTTP_REFERER"])) {
				$goBack = "<td class='textArea' colspan='2' align='center'>( <a href='" . htmlspecialchars($_SERVER["HTTP_REFERER"]) . "'>返回</a> | <a href='" . $config['url_path'] . "logout.php'>再次登录</a> )</td>";
			}else{
				$goBack = "<td class='textArea' colspan='2' align='center'>( <a href='" . $config['url_path'] . "logout.php'>再次登录</a> )</td>";
			}
			...
			<table width="450" align='center'>
				...
				<tr>
					<td class='textArea' colspan='2'>您没有权限访问Cacti的这个部分.如果您认为您需要访问这个部分,请联系您的Cacti管理员.</td>
				</tr>
				<tr>
					<?php print $goBack;?>
				</tr>
