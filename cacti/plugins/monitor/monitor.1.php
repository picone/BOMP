...
function render_host($host) {
	...
	$title = "<table cellpadding=0 cellspacing=0 width='250px'><tr><td colspan=2><b>$name</b></td></tr><tr valign=top><td>状态:</td><td>$sdisplay</td></tr><tr valign=top><td>IP地址:</td><td>$hostname</td></tr><tr valign=top><td>检测:</td><td>$ptime 毫秒</td></tr><tr valign=top><td>最后宕机时间:</td><td>$d</td></tr><tr valign=top><td>可用性:&nbsp;&nbsp;</td><td>$avail%</td></tr></table>";
