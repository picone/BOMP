...
function show_editor_startpage()
{
	...
	print '<div id="withjs">';
	print '<div id="dlgStart" class="dlgProperties" ><div class="dlgBody">';
	//print '欢迎使用气象图编辑器.<p>';
	//print '<div style="border: 3px dashed red; background: #055; padding: 5px; font-size: 90%;"><b>注意:</b>该编辑器尚未完成,某些功能还无法使用.无法使用的功能包括:括号,节点偏移,定义字体,更改颜色,各节点/链接设置和图片上传.然后您还是可以手动的编辑这些.</div>';
	print '<p>';
	
	print '请选择:<p>';
	print '添加一个新气象图:<br>';
	print '<form method="GET">';
	print '名称: <input type="text" name="mapname" size="20">';
	...
	print '或者<br /><br />从现有气象图复制新的气象图:<br><br />';
	print '<form method="GET">';
	print '命名为: <input type="text" name="mapname" size="20">&nbsp;&nbsp;&nbsp; 从现有文件 ';
	...
	print '</select>';
	print '<input type="submit" value="添加复制">';
	print '</form>';
	print '或者<br /><br />';
	print '打开一个现有的气象图(查看配置):<ul class="filelist">';
