 ...
 *
 */
$cacti_root = '/var/www/new_zabbix/cacti';
...
$fmt_cacti_graph = "graph_image.php?local_graph_id=%d&rra_id=0&graph_nolegend=true&graph_height=100&graph_width=300";
$fmt_cacti_graphpage ="graph.php?rra_id=all&local_graph_id=%d";
