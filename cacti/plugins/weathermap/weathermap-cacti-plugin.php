...
if($is_wm_admin)
{
	...
	print "[ <a href='weathermap-cacti-plugin-mgmt.php?action=map_settings&id=".$mapid."'>气象图设置</a> |";
	print "<a href='weathermap-cacti-plugin-mgmt.php?action=perms_edit&id=".$mapid."'>气象图权限</a> |";
	print "<a href=''>编辑气象图</a> ]";
	print "</span>";
}
...
<?php
		...
		{
			print "<div align=\"center\" style=\"padding:20px\"><em>该气象图尚未创建.";
...
function weathermap_show_manage_tab()
{
	...
	if ((db_fetch_assoc("select user_auth_realm.realm_id from user_auth_realm where user_auth_realm.user_id='" . $userid . "' and user_auth_realm.realm_id='$realm_id2'")) || (empty($realm_id2))) {
		...
		print '<a href="' . $config['url_path'] . 'plugins/weathermap/weathermap-cacti-plugin-mgmt.php">管理气象图</a>';
	}
}
...
<tr bgcolor="<?php print $colors["panel"];?>">
				...
				<td align="right"> <a href="?action=viewmapcycle" target="_blank">自动循环</a>所有全尺寸图片) </td>
				</tr>
			</table>
		</td>
</tr>
<tr>
<td><i>点击缩略图查看全尺寸图片(您也可以<a href="?action=viewmapcycle" target="_blank">自动循环</a>所有全尺寸图片)</i></td>
</tr>
<?php
		html_graph_end_box();
		...
		{
			print "<div align=\"center\" style=\"padding:20px\"><em>您没有气象图</em></div>\n";
		}
	}
}
...
<tr bgcolor="<?php print $colors["panel"];?>">
				...
				<td align="right">
				<?php if(! $cycle) { ?>
				<a href="?action=viewmapcycle">自动循环</a>所有全尺寸图片)
				<?php } else { ?>
				循环所有图片. <a href="?action=">停止.</a>
				<?php }?>
				</td>
				</tr>
			</table>
...
<?php
			...
			{
				print "<div align=\"center\" style=\"padding:20px\"><em>该气象图尚未创建.</em></div>";
			}
...
function weathermap_versionbox()
{
	...
	//$pagefoot = "<a href=\"http://www.network-weathermap.com/?v=$WEATHERMAP_VERSION\">PHP气象图版本$WEATHERMAP_VERSION</a>";
	...
	if ((db_fetch_assoc("select user_auth_realm.realm_id from user_auth_realm where user_auth_realm.user_id='" . $userid . "' and user_auth_realm.realm_id='$realm_id2'")) || (empty($realm_id2)))
	{
		//$pagefoot .= " --- <a href='weathermap-cacti-plugin-mgmt.php' title='气象图管理页面'>气象图管理</a>";
		//$pagefoot .= " | <a target=\"_blank\" href=\"docs/\">本地文档(英文)</a>";
		//$pagefoot .= "  <a href=\"editor.php\">编辑流量图</a>";
		$pagefoot = "  <a href=\"editor.php\">编辑流量图</a>";
	}
...
function weathermap_footer_links()
{
	...
	print '<br />';
    html_start_box("<center><a target=\"_blank\" class=\"linkOverDark\" href=\"docs/\">本地文档</a> -- <a target=\"_blank\" class=\"linkOverDark\" href=\"http://www.network-weathermap.com/\">气象图网站</a> -- <a target=\"_target\" class=\"linkOverDark\" href=\"weathermap-cacti-plugin-editor.php?plug=1\">气象图编辑器</a> -- 这个版本$WEATHERMAP_VERSION</center>", "78%", $colors["header"], "2", "center", "");
	html_end_box();
}
