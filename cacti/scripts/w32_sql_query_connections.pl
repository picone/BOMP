...
my $Win32_Class = "Win32_PerfFormattedData_MSSQLSERVER_SQLServerGeneralStatistics";
...
$script_name[((scalar(@script_name)) - 1)] computer action rvalue 
...
Examples:
   ...
   $script_name[((scalar(@script_name)) - 1)] localhost get FreePhysicalMemory
   $script_name[((scalar(@script_name)) - 1)] localhost get TotalVisibleMemorySize,FreePhysicalMemory
